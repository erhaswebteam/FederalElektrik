...
namespace Grand.Framework.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        {            
            ...
            builder.RegisterType<OrderPaymentService>().As<IOrderPaymentService>().InstancePerLifetimeScope();
            builder.RegisterType<BankInstallmentService>().As<IBankInstallmentService>().InstancePerLifetimeScope();
