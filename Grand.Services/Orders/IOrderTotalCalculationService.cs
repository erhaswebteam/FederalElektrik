...
namespace Grand.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        decimal? GetShoppingCartTotal(IList<ShoppingCartItem> cart, bool? useRewardPoints = null,
            bool usePaymentMethodAdditionalFee = true);
        ...
        decimal? GetShoppingCartTotal(IList<ShoppingCartItem> cart,
            ...
            out decimal redeemedRewardPoints, out decimal redeemedRewardPointsAmount,
        ...
        decimal ConvertRewardPointsToAmount(decimal rewardPoints);
        ...
        bool CheckMinimumRewardPointsToUseRequirement(decimal rewardPoints);
