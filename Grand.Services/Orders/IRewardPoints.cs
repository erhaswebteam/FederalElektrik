...
namespace Grand.Services.Orders
{
    ...
    public partial interface IRewardPointsService
    {
        ...
        decimal GetRewardPointsBalance(string customerId, string storeId);
        ...
        RewardPointsHistory AddRewardPointsHistory(string customerId, decimal points, string storeId, string message = "",
        ...
        void RemoveRewardPointsHistory(string customerId, string storeId);

        bool RemoveOldPointAndAddNewPoints(string CustomerId, decimal Point, string storeId, string message = null);
