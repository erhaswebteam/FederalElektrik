    ...
    public partial class OrderTotalCalculationService : IOrderTotalCalculationService
    {
            ...
            bool? useRewardPoints = null, bool usePaymentMethodAdditionalFee = true)
        {
            return GetShoppingCartTotal(cart,
                ...
                out decimal redeemedRewardPoints,
        ...
        public virtual decimal ConvertRewardPointsToAmount(decimal rewardPoints)
        {
            if (rewardPoints <= 0)
                return decimal.Zero;
        ...
        public virtual bool CheckMinimumRewardPointsToUseRequirement(decimal rewardPoints)
        {
