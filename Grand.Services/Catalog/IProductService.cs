...
namespace Grand.Services.Catalog
{
    ...
    public partial interface IProductService
    {
        ...
        void UpdateProductAdmin(Product product);
        /// <summary>
        /// Gets all products displayed on the home page
        /// </summary>
        /// <returns>Products</returns>
        IList<Product> GetAllProductsDisplayedOnHomePage();
        ProductDeleted GetDeletedProduct(string id);
        /// <summary>
        ...
        /// <param name="productId">Product identifier</param>
        /// <returns>Product</returns>
        IList<Product> GetAllPublishedProducts(string customerId, string storeId, int productsAlsoPurchasedNumber);
