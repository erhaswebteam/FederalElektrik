...
namespace Grand.Services.Customers
{
    ...
    public partial interface ICustomerService
    {
        ...
        List<Customer> GetMyRegisterDealer(string customerId, string bolge);

        Customer GetCustomerByEmailORVatNumber(string emailORVatnumber);
        ...
        void RemoveBillingAddress(string customerId);
