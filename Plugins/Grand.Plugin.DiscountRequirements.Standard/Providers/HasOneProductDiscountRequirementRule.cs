...
namespace Grand.Plugin.DiscountRequirements.HasOneProduct
{
    public partial class HasOneProductDiscountRequirementRule : IDiscountRequirementRule
    {
        ...
        public string SystemName => "DiscountRequirements.HasOneProduct";
