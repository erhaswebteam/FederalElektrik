...
namespace Grand.Plugin.Widgets.MobileSlider.Infrastructure.Cache
{
    /// <summary>
        ...
        IConsumer<EntityDeleted<Setting>>
    {
        ...
        /// {0} : picture id
        /// </remarks>
        public const string PICTURE_URL_MODEL_KEY = "Grand.plugins.widgets.mobileslider.pictureurl-{0}";
        public const string PICTURE_URL_PATTERN_KEY = "Grand.plugins.widgets.mobileslider";
