...
namespace Grand.Plugin.Widgets.MobileSlider.Models
{
    public class ConfigurationModel : BaseGrandModel
    {
        ...
        [GrandResourceDisplayName("Plugins.Widgets.MobileSlider.Picture")]
        [UIHint("Picture")]
        public string Picture1Id { get; set; }
        public bool Picture1Id_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Plugins.Widgets.MobileSlider.Text")]        
        public string Text1 { get; set; }
        public bool Text1_OverrideForStore { get; set; }

        [GrandResourceDisplayName("Plugins.Widgets.MobileSlider.Link")]        
