...
namespace Grand.Plugin.Widgets.MobileSlider.Controllers
{
    [AuthorizeAdmin]
    [Area("Admin")]
    public class WidgetsMobileSliderController : BasePluginController
    {
        ...
        public WidgetsMobileSliderController(IWorkContext workContext,
        ...
        public IActionResult Configure()
        {
            ...
            var sliderSettings = _settingService.LoadSetting<MobileSliderSettings>(storeScope);
            ...
            return View("~/Plugins/Widgets.MobileSlider/Views/Configure.cshtml", model);
        }
