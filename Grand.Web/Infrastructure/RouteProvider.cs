...
namespace Grand.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            //register
            routeBuilder.MapLocalizedRoute("NewDealer",
                            "newdealer/",
                            new { controller = "Customer", action = "NewDealer" });
            ...
            routeBuilder.MapLocalizedRoute("MyRegisterDealer",
                            "customer/myregisterdealer",
                            new { controller = "Customer", action = "MyRegisterDealer" });
            ...
            routeBuilder.MapLocalizedRoute("ProcessHistory",
                      "customer/processhistory",
                      new { controller = "Customer", action = "ProcessHistory" });

            routeBuilder.MapLocalizedRoute("PointTransfer",
                      "customer/pointtransfer",
                      new { controller = "Customer", action = "PointTransfer" });
            ...
            routeBuilder.MapRoute(
                "BankInstallmentPage",
                "Admin/BankInstallment",
            new { controller = "BankInstallment", action = "Index" });

            //apply for vendor account
            routeBuilder.MapLocalizedRoute("CodecSMS",
                            "codec/sendsms",
                            new { controller = "SMS", action = "SendSms" });
