    ...
    nextStep: function (response) {
        if (response.update_section) {
            if (response.update_section.html) {
                if (response.update_section.html.toString().includes("yeterli stok bulunama")) {
                    $.ajax({
                        type: "POST",
                        url: "/Checkout/GetCartPartial",
                    ...
                    $('#errorContainer').html(response.update_section.html.toString());
                    $('#cartModal').modal();
                }
            }
        }
