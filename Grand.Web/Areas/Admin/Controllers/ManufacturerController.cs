...
namespace Grand.Web.Areas.Admin.Controllers
{
    public partial class ManufacturerController : BaseAdminController
    {
        ...
        public IActionResult List()
        {
            ...
            //    manu.Locales = new List<ManufacturerLocalizedModel>();
            //    manu.Locales.Add(new ManufacturerLocalizedModel()
            //    {
            //        LanguageId = "5b166037b5b4be34b45c3f84", //türkçe dil için veritabanındaki _id
            //        SeName = manufacturer.SeName
            //    });

            //    manufacturer.UpdatedOnUtc = DateTime.UtcNow;
            //    manufacturer.Locales = UpdateLocales(manufacturer, manu);
